...
model = joblib.load('lasso_model (1).joblib')
...
if submit_button:
    data = {'numberPriorJobs': numberPriorJobs,'proportion401K': proportion401K,'startingSalary': startingSalary,'currentSalary': currentSalary,'performance': performance,'monthsToSeparate': monthsToSeparate,'workDistance': workDistance,'department_1': department_1,'department_2': department_2,'department_3': department_3, 'missing_feature': 0}
